...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('post-thumb', 500, 210, true);
    add_image_size('page-featured', 960, 320, true);
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('First / left area in footer.', 'html5blank'),
        'id' => 'footer-widget-1',
        'before_widget' => '<div id="%1$s" class="%2$s Grid-cell">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ));
    ...
    register_sidebar(array(
        ...
        'description' => __('Second / center area in footer.', 'html5blank'),
        'id' => 'footer-widget-2',
        'before_widget' => '<div id="%1$s" class="%2$s Grid-cell">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
    ...
    register_sidebar(array(
        ...
        'description' => __('Third / right area in footer.', 'html5blank'),
        'id' => 'footer-widget-3',
        'before_widget' => '<div id="%1$s" class="%2$s Grid-cell">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
...
function html5_blank_view_article($more)
{
    global $post;
    return '...';
  //<br><a class="view-article" href="' . get_permalink($post->ID) . '">' . __('View Article', 'html5blank') . '</a>';
}
